...
export default function DashboardLayout({
  ...
  useEffect(() => {
    console.log('🏠 [Dashboard Layout] Auth state:', { loading, hasUser: !!user, userName: user?.name });
    
    if (!loading && !user) {
      console.log('🏠 [Dashboard Layout] No user found, will redirect to login');
      // Small delay to allow any pending localStorage operations
      const redirectTimer = setTimeout(() => {
        console.log('🏠 [Dashboard Layout] Redirecting to login now');
